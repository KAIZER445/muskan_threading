...
interface Feature {
  name: string;
  icon: string; // Placeholder for SVG path or URL
}
...
const Layoutsthree: React.FC<LayoutThreeProps> = ({ title, description, features, image1, image2, towel_icon }) => {
  // Hardcoded SVG path for now, since the API provides a placeholder
      ...
      <div className="container mx-auto py-20 flex flex-col md:flex-row px-0 lg:px-32">
        ...
        <div className="w-full md:w-1/2">
          <div className="p-4">
              ...
              <div className="w-full md:w-1/2">
                <ul>
                  {features.slice(0, 3).map((feature, index) => (
                    <li key={index} className="p-1 flex gap-2">
                      <svg
                        fill="#000000"
                        height="20px"
                        width="20px"
            ...
            <div className="pt-10">
              <div className="border inline-block rounded-xl px-3 py-2">
