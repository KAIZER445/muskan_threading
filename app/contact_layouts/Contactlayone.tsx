      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        <div className="md:col-span-3">
          <div className="lg:pt-20 pt-3">
            <h1
              className="font-semibold text-3xl uppercase px-10 leading-relaxed tracking-wide"
              dangerouslySetInnerHTML={{ __html: title }}
            />
            <p className="px-10 pt-10 text-justify text-lg leading-relaxed">{description}</p>
          </div>
          <div className="pt-15 px-10 flex gap-6">
            {services.map((service, index) => (
              <div
                key={index}
                className="border inline-block rounded-lg bg-[#f1e9e1] border-gray-400 border-3"
              >
                <div className="flex items-center gap-5 px-3 py-5">
                  ...
                  <p className="uppercase font-bold">{service}</p>
                </div>
              </div>
            ))}
          </div>
                  ...
                  <g>
                    <g>
                      ...
                      <path d="M17.573,24.253l-1.12-2.078l1.028-2.146l-1.028-0.311l-1.156-1.159l-2.56-0.573l-0.85-1.779v1.057h-0.375l-1.625-2.203
                        ...
                        c-0.966,2.009-1.52,4.252-1.52,izard-1.52,6.63c0,8.502,6.891,15.396,15.393,15.396c0.654,0,1.296-0.057,1.931-0.135l-0.161-1.864
