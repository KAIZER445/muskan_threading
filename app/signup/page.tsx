    ...
    return (
        <div className="container mx-auto lg:px-30 px-2">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="w-full w-1/2">
                        <div className="relative h-full">
                            <img src="https://img.freepik.com/free-photo/medium-shot-smiley-tattoo-artist-drawing_23-2149445989.jpg?t=st=1746007098~exp=1746010698~hmac=a8e48d5db9ed2dc8c78139a270114b12e52083cb22d805aa0f277a3aaf6686f6&w=740" alt="" className="rounded-t-2xl  lg:rounded-none lg:rounded-l-2xl w-full h-full object-cover" />
                            <div className="absolute top-10 left-1/2 transform -translate-x-1/2 text-center">
                                <h1 className="text-2xl lg:pt-10 pt-2 font-extrabold bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 bg-clip-text text-transparent uppercase">
                                    Muskan Threading
                                </h1>
                                <p className="mt-2 text-white text-sm py-2 ">
                                Create your account and begin your journey with Muskan Threading where beauty meets precision and self-care begins.
                                </p>
                            </div>
                            <div className="absolute bottom-0">
                                <svg fill="#ffff" height="80px" width="80px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 260.204 260.204">
                                    <g>
                                        <g>
                                            <g>
				...
				c0.688,0.42,1.16,1.076,1.332,1.844C111.006,247.304,109.922,248.908,108.238,249.284z"/>
                            ...
                            <div className="absolute top-0">
                                <svg fill="#ffff" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                    width="80px" height="80px" viewBox="0 0 377.114 377.115"
                                >
                                    <g>
                                        <g>
			...
			C378.5,45.656,376.663,40.147,375.439,36.476z"/>
                    ...
                    <div className="w-full w-1/2 shadow-lg lg:rounded-r-2xl lg:rounded-none rounded-b-2xl">
                        <div className="">
                            <div className="">
                                <p className="text-xl text-center lg:pt-10 pt-3 font-extrabold bg-gradient-to-r from-red-500 via-black-500 to-yellow-500 bg-clip-text text-transparent uppercase">
                                    Register Your Account
                                </p>
                            </div>
                            <div className="lg:px-20 px-4 py-7">
                                <div className="firstname flex flex-col static w-full py-2">
                                    <label htmlFor="" className="text-sm font-bold relative top-2 ml-[7px] px-[3px] bg-gray-100 w-fit rounded">First Name</label>
                                    <input type="text" placeholder="Your First Name" className="pt-[11px] pb-[11px] px-[10px] text-lg border-2 border-gray-400 rounded-[5px] bg-gray-200 focus:outline-none" />
                                </div>
                                <div className="firstname flex flex-col static w-full py-2">
                                    <label htmlFor="" className="text-sm font-bold relative top-2 ml-[7px] px-[3px] bg-gray-100 w-fit rounded">Last Name</label>
                                    <input type="text" placeholder="Your Last Name" className="pt-[11px] pb-[11px] px-[10px] text-lg border-2 border-gray-400 rounded-[5px] bg-gray-200 focus:outline-none" />
                                </div>

                                <div className="firstname flex flex-col static w-full py-3">
                                    <label htmlFor="" className="text-sm font-bold relative top-2 ml-[7px] px-[3px] bg-gray-100 w-fit rounded">Email</label>
                                    <input type="email" placeholder="Your Email" className="pt-[11px] pb-[11px] px-[10px] text-lg border-2 border-gray-400 rounded-[5px] bg-gray-200 focus:outline-none" />
                                </div>
                                <div className="firstname flex flex-col static w-full py-3">
                                    <label htmlFor="" className="text-sm font-bold relative top-2 ml-[7px] px-[3px] bg-gray-100 w-fit rounded">Password</label>
                                    <input type="password" placeholder="Password" className="pt-[11px] pb-[11px] px-[10px] text-lg border-2 border-gray-400 rounded-[5px] bg-gray-200 focus:outline-none" />
                                </div>
                                <div className="firstname flex flex-col static w-full py-2">
                                    <label htmlFor="" className="text-sm font-bold relative top-2 ml-[7px] px-[3px] bg-gray-100 w-fit rounded">Confirm Password</label>
                                    <input type="email" placeholder="Confirm Password" className="pt-[11px] pb-[11px] px-[10px] text-lg border-2 border-gray-400 rounded-[5px] bg-gray-200 focus:outline-none" />
                                </div>
                                <div className="w-full flex flex-col items-center py-4">
                                    <h2 className="text-lg font-semibold mb-1 text-gray-800">Verify OTP</h2>
                                    <p className="text-sm text-gray-600 mb-4 text-center">
                                        We’ve sent a 4-digit verification code to your email. Please enter it below.
                                    </p>

                                    <div className="otp-boxes flex justify-center gap-4">
                                        <input
                                            type="text"
                                            inputMode="numeric"
                                            maxLength={1}
                                            className="w-12 h-12 text-center text-lg border-2 border-gray-400 rounded-[5px] bg-gray-200 focus:outline-none"
                                        />
                                        <input
                                            type="text"
                                            inputMode="numeric"
                                ...
                                <div className="py-5">
                                    <div className="w-full flex justify-center">
                                        <button className="flex justify-center items-center gap-4 w-1/2 bg-[#007ACC] px-[15px] py-[10px]  outline outline-[3px] outline-[#007ACC]  outline-offset-[-3px] rounded-[5px] border-none cursor-pointer transition duration-[400ms] hover:bg-transparent group">
                                            <p className="text-white font-bold text-base transition duration-[400ms] group-hover:text-[#007ACC]">Sign Up</p>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-center py-3">
                                    <button className="flex justify-center items-center gap-5  rounded-[5px] border-2 text-[16px] font-semibold cursor-pointer transition-all duration-[250ms] relative overflow-hidden z-[1] px-10 py-3">
                                        <svg className="icon" viewBox="0 0 24 24" width="30px" height="30px">
                                ...
                                <div className="flex gap-3 justify-center py-5">
                                    ...
                                    <Link href='/login' className="text-blue-500">Login Now !</Link>
                                </div>
                            </div>
                        </div>
                    </div>
